    ...
    const coursesData = {
        'fin-game': {
            ...
            program: [
                ...
                'Чтобы заказать игру - необходимо 1) Выбрать игру (на основании месяца, в которым вы хотите провести фин-игру)',
                '2) В сообщении к заявке указать фин-игру (можно дату также), а также школу и класс где хотите провести (8А, 10Б и т.п.)',
                '3) Не забудьте указать контакт администрации и его номер телефона (иначе как мы согласуем фин-игру со школой?)',
                'Здесь представлен план проведения фин-игр на каждый месяц. Обратите внимание!',
                '► Октябрь - «Финансовый выживач»',
                '► Ноябрь - «Корпорация успеха»',
                '► Декабрь - «Экономический совет: битва регионов»',
                '► Февраль - «Продажный квиз»',
                '► Март - «Виртуальный стартап»',
                '► Апрель - «Кошмар аудитора»',
                '► Май - «Деловая этика в действии»',
                'Возникли вопросы? Звоните по телефону +7 906 963-57-56 (Другова Татьяна Викторовна)'
            ],
            lifehacks: []
        }
    };
